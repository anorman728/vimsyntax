" Vim syntax file
" MODIFIED FOR CDATA TO BE PHP!!!
" Language:	XML
" Maintainer:	Johannes Zellner <johannes@zellner.org>
"		Author and previous maintainer:
"		Paul Siegmann <pauls@euronet.nl>
" Modifier: Andrew Norman
...
" CData sections (MODIFIED!)
"
" PROVIDES: @xmlCdataHook
"
syn  include @php $VIMRUNTIME/syntax/php.vim
syn region    xmlCdata
    \ start=+<!\[CDATA\[+
    \ end=+]]>+
    \ contains=xmlCdataStart,xmlCdataEnd,@xmlCdataHook,@Spell,@php
    \ keepend
    \ extend
...
" MODIFIED: Commented this out because it wasn't working correctly.
